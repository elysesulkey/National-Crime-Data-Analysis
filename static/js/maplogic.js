...
info.update = function (props) {
    this._div.innerHTML = '<h4>U.S. Violent Crime Data 2019</h4>' + (props ?
...
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    id: 'mapbox/light-v9',
    attribution: "2019 US Crime Data",
    tileSize: 512,
    zoomOffset: -1,
...
geojson = L.geoJson(statesData2019, { style: style, onEachFeature: onEachFeature }).addTo(map);
